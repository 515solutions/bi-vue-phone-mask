...
export const findFirstCountryByCode = code => {
    ...
    const filteredCountries = allCountries.filter(contryArr => contryArr[2] === filteredCode && contryArr[3]);
...
export const findFirstCountryByAlpha2 = alpha2 => {
    ...
    const filteredCountries = allCountries.filter(contryArr => contryArr[1] === alpha2);
...
export const getMaskToLibPhoneNumber = libPhoneNumberObj => {
    ...
    const filteredCountries = allCountries.filter(contryArr => contryArr[1].toUpperCase() === contry.toUpperCase());
    if(!filteredCountries[0]){
        return null;
    }
    let mask = filteredCountries[0][3] ? filteredCountries[0][3].replace(/\./g,"#") : null;
    return {
